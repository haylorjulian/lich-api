...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, auth, token, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, UserService.find(email)];
            case 1:
                user = _b.sent();
            ...
            case 2:
                auth = _b.sent();
                if (user && auth) {
                    token = jsonwebtoken_1.default.sign({ user_id: user._id, email: email }, TOKEN_KEY, {
                        expiresIn: "2h",
                    });
                    user.token = token;
